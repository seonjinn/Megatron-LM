...
class HuggingFaceCheckpointLoaderMoE(HuggingFaceCheckpointLoaderHybrid):
    ...
    def build_checkpoint_metadata(self, true_vocab_size):
        ...
        md.moe_router_num_groups = self.hf_config.n_groups
...
def load_checkpoint(queue, args):
    ...
    """
    loader = HuggingFaceCheckpointLoaderMoE(args, queue)
    try:
        loader.load()
