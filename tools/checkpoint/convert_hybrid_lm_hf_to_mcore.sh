...
if [ $# -lt 2 ]; then
    ...
    echo "Usage: sbatch $0 <input_dir> <output_dir> [target_tp]"
    echo "  input_dir  - Path to input HF checkpoint directory"
    echo "  output_dir - Path to output mcore checkpoint directory"
