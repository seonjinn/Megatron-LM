...
#SBATCH --job-name=nano_v35_pretrain_a2_svg_0611

MODEL_NAME=${MODEL_NAME:-nano_v35_pretrain_a2_svg_0611}
...
FREEZE_ARGS="--freeze-LM --freeze-ViT"
STAGE_EXTRA_ARGS=""
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${WORKSPACE}/output/nano_v35_pretrain_a1_svg_0611/checkpoints"}
DATA_TRAIN=${DATA_TRAIN:-"${SOURCE}/examples/multimodal/super/data_config/a2_yamls/audio_stage2.yaml"}
BZ=${BZ:-512}
LR=${LR:-2.5e-5}
MIN_LR=${MIN_LR:-0.0}
