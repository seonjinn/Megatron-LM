...
#SBATCH --job-name=nano_v35_sft_conv3d_radiov4_1377_svg_0611

MODEL_NAME=${MODEL_NAME:-nano_v35_sft_conv3d_radiov4_1377_svg_0611}
...
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${WORKSPACE}/output/nano_v35_pretrain_radiov4_1377_svg_0611/checkpoints"}
DATA_TRAIN=${DATA_TRAIN:-"${SOURCE}/examples/multimodal/super/data_config/yamls/1377_video_text.yaml"}
BZ=${BZ:-256}
LR=${LR:-5e-5}
MIN_LR=${MIN_LR:-0.0}
