...
#SBATCH --job-name=nano_v35_vlm_sft_conv3d_radiov4_1377

MODEL_NAME=${MODEL_NAME:-nano_v35_vlm_sft_conv3d_radiov4_1377}
...
LANGUAGE_RECOMPUTE_MODULES=${LANGUAGE_RECOMPUTE_MODULES:-"mlp moe"}
VISION_RECOMPUTE_NUM_LAYERS=${VISION_RECOMPUTE_NUM_LAYERS:-16}
...
FREEZE_ARGS=""
STAGE_EXTRA_ARGS=" --log-model-grad-norms --log-model-act-norms --allow-checkpoint-without-temporal-compression "
VISION_PRETRAIN_RUN_NAME=${VISION_PRETRAIN_RUN_NAME:-"nano_v35_vision_pretrain_radiov4_1377"}
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${WORKSPACE}/output/${VISION_PRETRAIN_RUN_NAME}/checkpoints"}
