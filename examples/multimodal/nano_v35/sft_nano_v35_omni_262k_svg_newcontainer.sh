...
#SBATCH --job-name=nano_v35_omni_262k_svg_0611

MODEL_NAME=${MODEL_NAME:-nano_v35_omni_262k_svg_0611}
...
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${WORKSPACE}/output/nano_v35_omni_49k_svg_0611/checkpoints"}
DATA_TRAIN=${DATA_TRAIN:-"${SOURCE}/examples/multimodal/super/data_config/sft_mmlongbench_txt_yamls/sft_mmlongbench_txt.yaml"}
DECODER_SEQ_LEN=${DECODER_SEQ_LEN:-262144}
PACKING_SEQ_LEN=${PACKING_SEQ_LEN:-262144}
PBS=${PBS:-512}
BZ=${BZ:-64}
LR=${LR:-1e-6}
MIN_LR=${MIN_LR:-0.0}
