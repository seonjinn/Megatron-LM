...
#SBATCH --job-name=nano_v35_omni_16k_svg_0611

MODEL_NAME=${MODEL_NAME:-nano_v35_omni_16k_svg_0611}
...
FREEZE_ARGS=""
STAGE_EXTRA_ARGS=" --tokenizer-keep-history-thinking "
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${WORKSPACE}/output/nano_v35_pretrain_a2_svg_0611/checkpoints"}
