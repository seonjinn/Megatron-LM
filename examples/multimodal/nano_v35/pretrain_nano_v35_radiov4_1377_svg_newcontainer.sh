...
#SBATCH --job-name=nano_v35_pretrain_radiov4_1377_svg_0611

MODEL_NAME=${MODEL_NAME:-nano_v35_pretrain_radiov4_1377_svg_0611}
...
DATA_TRAIN=${DATA_TRAIN:-"${SOURCE}/examples/multimodal/super/data_config/yamls/pretrain_vision_adaptor_recipe.yaml"}
BZ=${BZ:-128}
LR=${LR:-1e-3}
MIN_LR=${MIN_LR:-1e-5}
