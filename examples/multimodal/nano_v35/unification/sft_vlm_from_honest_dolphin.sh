...
#SBATCH --job-name=nano35_from_honest_dolphin_vlm_sft_0724

set -euo pipefail

# Standalone multimodal SFT for the Nano v3.5 combined-omni experiment.
...
EXPERIMENT_ID=${EXPERIMENT_ID:-"nano35_from_honest_dolphin_vlm_sft_0724"}
# VISION_PRETRAIN_MODEL_NAME=${VISION_PRETRAIN_MODEL_NAME:-"${EXPERIMENT_ID}_vision_adapter_pretrain"}
VISION_PRETRAIN_MODEL_NAME="nano_v35_base3p5_combined_omni_16k_vlm_only_vision_adapter_pretrain_0723_dss_cache_fix_new"
MODEL_NAME=${MODEL_NAME:-"nano35_from_honest_dolphin_vlm_sft_0724"}
...
# CHECKPOINT_DIR="/lustre/fs1/portfolios/llmservice/projects/llmservice_fm_vision/users/tpoon/workspace/output/nano_v35_base3p5_combined_omni_16k_vlm_only_vision_adapter_pretrain/checkpoints"
