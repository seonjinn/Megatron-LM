...
#SBATCH --job-name=sft_omni_300k_0228

# !! Example launch command !!
# examples/multimodal/launch.sh --name sft_omni_300k_0228 --sbatch examples/multimodal/v3_omni_staged_conv3d/sft_long_context.sh --num-jobs 1
...
MODEL_NAME=${MODEL_NAME:-"sft_omni_300k_0228"}
DATA_TRAIN=${DATA_TRAIN:-"__CODE_DIR__/examples/multimodal/v3_omni_staged_conv3d/sft_long_context_rebalanced.yaml"}

# Conv3d video defaults (w/ allowed overrides via env vars)
VIDEO_MAX_NUM_FRAMES=${VIDEO_MAX_NUM_FRAMES:-512}  # Using conv3d w/ 2-frame compression
...
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/sft_omni_13p70_0224/checkpoints"}
