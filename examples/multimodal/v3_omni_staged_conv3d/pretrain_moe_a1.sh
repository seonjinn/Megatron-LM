...
#SBATCH --job-name=pretrain_moe_a1_conv3d_no_change_0222

# !! Example launch command !!
# examples/multimodal/launch.sh \
# --name pretrain_moe_a1_conv3d_no_change_0222 \
...
MODEL_NAME=${MODEL_NAME:-"pretrain_moe_a1_conv3d_no_change_0222"}
DATA_TRAIN=${DATA_TRAIN:-"__CODE_DIR__/examples/multimodal/v3_omni_staged_conv3d/pretrain_moe_a1.yaml"}
...
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/sft_moe_rl_llm_2e_bs_x2_radio_v4_h_rc2_v1370vid_conv3d_vf32a_sep_0220/checkpoints"}
...
# # Conv3d may need more memory; add recomputation
