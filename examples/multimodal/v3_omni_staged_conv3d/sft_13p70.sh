...
#SBATCH --job-name=sft_omni_13p70_0224

# !! Example launch command !!
# examples/multimodal/launch.sh --name sft_omni_13p70_0224 --sbatch examples/multimodal/v3_omni_staged_conv3d/sft_13p70.sh --num-jobs 1
...
MODEL_NAME=${MODEL_NAME:-"sft_omni_13p70_0224"}
DATA_TRAIN=${DATA_TRAIN:-"__CODE_DIR__/examples/multimodal/v3_omni_staged_conv3d/sft_recipe_13p70.yaml"}
...
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/pretrain_moe_a2_conv3d_0223/checkpoints"}
