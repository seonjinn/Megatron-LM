...
#SBATCH --job-name=pretrain_moe_pxshuf_radio_v4_h_1211
...
# Normal LR
# - - - - -
# JOB_NAME="pretrain_moe_pxshuf_radio_v4_h_1211"
# mkdir -p $SHARE_OUTPUT/workspace/output/$JOB_NAME/logs

# sbatch \
# --job-name=$JOB_NAME \
# --output=$SHARE_OUTPUT/workspace/output/$JOB_NAME/logs/%x_%j_sbatch.log \
# $SHARE_OUTPUT/megatron-lm-tot/examples/multimodal/v3/pretrain_moe_radio_v4.sh

# - - - - -
# Reduced LR
# - - - - -
# JOB_NAME="pretrain_moe_pxshuf_radio_v4_h_lr1e-4_1211"
# mkdir -p $SHARE_OUTPUT/workspace/output/$JOB_NAME/logs

# LR=1e-4 MIN_LR=1e-6 MODEL_NAME=$JOB_NAME sbatch \
# --job-name=$JOB_NAME \
# --output=$SHARE_OUTPUT/workspace/output/$JOB_NAME/logs/%x_%j_sbatch.log \
# $SHARE_OUTPUT/megatron-lm-tot/examples/multimodal/v3/pretrain_moe_radio_v4.sh
# --------------------
...
# Defaults, w/ optional override with exports
LR=${LR:-1e-3}
MIN_LR=${MIN_LR:-1e-5}
MODEL_NAME=${MODEL_NAME:-"pretrain_moe_pxshuf_radio_v4_h_1211"}
SOURCE=${SOURCE:-$(pwd)}
DRY_RUN=${DRY_RUN:-0}  # For debugging
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/projects/llmservice_nlp_fm/artifacts/mcore/vlm_checkpoints/v3-sft-16gbs-lurking-ringtail-lc-v2-1e-5-constant-c-radio_v4-h-tp2"
