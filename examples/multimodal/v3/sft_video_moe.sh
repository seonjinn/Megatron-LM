...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_sft_video_moe_${DATETIME}"
...
TP=2
EP=32
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/output/sft_moe_1029/checkpoints"
