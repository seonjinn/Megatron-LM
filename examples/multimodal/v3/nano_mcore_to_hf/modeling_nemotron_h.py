...
class NemotronHMoE(nn.Module):
    ...
    Uses nn.ModuleList of NemotronHMLP experts to match checkpoint weight format.
    """
    ...
    def __init__(self, config, layer_idx: int | None = None):
        ...
        self.experts = nn.ModuleList(
            [NemotronHMLP(config, intermediate_size=config.moe_intermediate_size) for _ in range(config.n_routed_experts)]
        )
