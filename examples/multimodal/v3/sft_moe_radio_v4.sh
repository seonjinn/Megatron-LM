...
#SBATCH --job-name=sft_moe_pxshuf_radio_v4_h_1211
...
MODEL_NAME=${MODEL_NAME:-"sft_moe_pxshuf_radio_v4_h_1211"}
SOURCE=${SOURCE:-$(pwd)}
...
TP=2
EP=32
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/cmccarthy/workspace/output/pretrain_moe_pxshuf_radio_v4_h_1211/checkpoints"
