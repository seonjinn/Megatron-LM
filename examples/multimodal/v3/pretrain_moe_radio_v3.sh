...
#SBATCH --job-name=pretrain_moe_pxshuf_radio_v3_h_1211
...
# Lauch command
# --------------------
# JOB_NAME="pretrain_moe_pxshuf_radio_v3_h_1211"
# mkdir -p $SHARE_OUTPUT/workspace/output/$JOB_NAME/logs

# sbatch \
# --job-name=$JOB_NAME \
# --output=$SHARE_OUTPUT/workspace/output/$JOB_NAME/logs/%x_%j_sbatch.log \
# $SHARE_OUTPUT/megatron-lm-tot/examples/multimodal/v3/pretrain_moe_radio_v3.sh
# --------------------
...
LR=${LR:-1e-3}
MIN_LR=${MIN_LR:-1e-5}
MODEL_NAME=${MODEL_NAME:-"pretrain_moe_pxshuf_radio_v3_h_1211"}
SOURCE=${SOURCE:-$(pwd)}
...
SOURCE="/lustre/fsw/portfolios/llmservice/users/cmccarthy/megatron-lm-tot"
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/projects/llmservice_nlp_fm/artifacts/mcore/vlm_checkpoints/v3-sft-16gbs-lurking-ringtail-lc-v2-1e-5-constant-c-radio_v3-h-tp2"
