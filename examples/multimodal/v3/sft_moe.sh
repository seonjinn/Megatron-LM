...
#SBATCH --job-name=sft_moe_0930_2
...
TP=2
EP=32
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/output/pretrain_moe_0928_nodeepep/checkpoints"
