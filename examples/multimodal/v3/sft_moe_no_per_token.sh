...
#SBATCH --job-name=sft_moe_no_per_token_1204
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_moe_no_per_token_1204"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
TP=2
EP=32
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/pretrain_moe_dyres_no_per_token_1204/checkpoints"
