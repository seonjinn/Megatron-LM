...
#SBATCH --job-name=sft_moe_video_1211
...
TP=2
EP=32
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/sft_moe_dyres_max_patch_data_aug_1201/checkpoints"
