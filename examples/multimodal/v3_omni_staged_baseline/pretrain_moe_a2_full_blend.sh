...
#SBATCH --job-name=pretrain_moe_a2_full_blend_0212
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_pretrain_moe_a2_full_blend_${DATETIME}"
    SPECIAL_TOKENS=" --special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box> <so_embedding> <so_start> <so_end> "
    DEBUG=1
else
    MODEL_NAME="pretrain_moe_a2_full_blend_0212"
    SPECIAL_TOKENS=" --special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\> \<so_embedding\> \<so_start\> \<so_end\> "
fi
...
CHECKPOINT_DIR=/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/pretrain_moe_a1_0210/checkpoints
...
DATA_TRAIN="${SOURCE}/examples/multimodal/v3_omni_staged_baseline/pretrain_moe_a2_full_blend.yaml"
