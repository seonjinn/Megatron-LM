...
#SBATCH --job-name=pretrain_moe_a2_higher_lr_0328

# !! Example launch command !!
# examples/multimodal/launch.sh --name pretrain_moe_a2_higher_lr_0328 --sbatch examples/multimodal/v3_omni_staged_conv3d_ga/pretrain_moe_a2_higher_lr.sh --num-jobs 5
...
MODEL_NAME=${MODEL_NAME:-"pretrain_moe_a2_higher_lr_0328"}
DATA_TRAIN=${DATA_TRAIN:-"__CODE_DIR__/examples/multimodal/v3_omni_staged_conv3d_ga/pretrain_moe_a2.yaml"}
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/pretrain_moe_a1_0327/checkpoints"
