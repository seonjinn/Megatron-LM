...
#SBATCH --job-name=sft_recipe_13p77_0329

# !! Example launch command !!
# examples/multimodal/launch.sh --name sft_recipe_13p77_0329 --sbatch examples/multimodal/v3_omni_staged_conv3d_ga/sft_13p77.sh --num-jobs 10
...
MODEL_NAME=${MODEL_NAME:-"sft_recipe_13p77_0329"}
DATA_TRAIN=/lustre/fsw/portfolios/llmservice/users/matthieul/repos_0220/megatron-lm/examples/multimodal/v3_omni_staged_conv3d_ga/sft_recipe_13p77.yaml
...
# Starting checkpoint: A2 checkpoint (update this path after training A2)
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/pretrain_moe_a2_higher_lr_0328/checkpoints"
