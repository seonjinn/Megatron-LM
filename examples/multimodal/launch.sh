...
# - - - - - - - - - -
# With env var overrides / extra args:
# - - - - - - - - - -
# VISION_REDUCED_LR=1 \
# CHECKPOINT_DIR=$SHARE_OUTPUT/workspace/output/pretrain_moe_rl_llm_vision_eval_mode_radio_v4_rlr_1212/checkpoints \
# ./examples/multimodal/launch.sh \
#   --source $SHARE_OUTPUT/megatron-lm-tot \
#   --name sft_moe_rl_llm_vision_eval_mode_radio_v4_vis-rlr_1212 \
#   --sbatch examples/multimodal/v3_experiments/sft_moe_rl_llm_eval_mode_radio_multi_two_epochs_bs_x2.sh \
#   --num-jobs 5 \
...
if [[ -z "$SBATCH_FILE" || -z "$MODEL_NAME" ]]; then
    echo "Usage: $0 --sbatch <my_sbatch.sh> --name <job_name> [options...]"
    echo "Options:"
