...
# examples/multimodal/launch.sh --name sft_mmlongbench_txt_0403 --sbatch examples/multimodal/v3_baseline/sft_mmlongbench_txt.sh --num-jobs 10
...
DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/matthieul/data/data_recipe/stages/vlm_long_context/vlm_long_context.yaml"
