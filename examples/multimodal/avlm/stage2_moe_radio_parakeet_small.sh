...
#SBATCH --job-name=stage2_moe_radio_parakeet_small_1106
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_stage2_moe_radio_parakeet_small_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box> <so_embedding> <so_start> <so_end> "
    DEBUG=1
else
    MODEL_NAME="stage2_moe_radio_parakeet_small_1106"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\> \<so_embedding\> \<so_start\> \<so_end\> "
fi
...
TP=2
EP=4
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/output/stage1p5_moe_radio_parakeet_small_1106/checkpoints"
