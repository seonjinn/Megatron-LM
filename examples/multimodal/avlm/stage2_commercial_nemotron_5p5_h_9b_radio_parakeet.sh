...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="draco-mcore-nm_5p5_h_9b-cradio-parakeet-nemo-stage2-alm-nodes${SLURM_NNODES}-seq${DECODER_SEQ_LEN}-bz${BZ}-tp${TP}-vlm2-branch-memory-efficient-1015"
