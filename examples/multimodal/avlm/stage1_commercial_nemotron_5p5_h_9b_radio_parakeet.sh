...
# EXTRA_ARGS+=" --recompute-granularity full --recompute-method block --recompute-num-layers 32 --recompute-vision --recompute-sound" # --use-flash-attn"
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="draco-mcore-nm_5p5_h_9b-cradio-parakeet-nemo-stage1-alm-nodes${SLURM_NNODES}-seq${DECODER_SEQ_LEN}-bz${BZ}-tp${TP}-vlm2-branch-1001"
...
# WORKSPACE=/lustre/fsw/portfolios/llmservice/users/ehosseiniasl/avlm_halfduplex/mcore_results
SOURCE=`pwd`
