...
#SBATCH --job-name=stage1p5_moe_radio_parakeet_small_1106
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_stage1p5_moe_radio_parakeet_small_${DATETIME}"
    MODEL_NAME="stage1p5_moe_radio_parakeet_small_1106"
...
TP=2
EP=4
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/output/pretrain_moe_radio_parakeet_small_1105/checkpoints"
