...
#SBATCH --job-name=sft_super_final_ckpt_conv3d_radiov4_1370_0311
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_super_final_ckpt_conv3d_radiov4_1370_0311"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/scratch/fsw/portfolios/llmservice/users/tpoon/workspace/output/pretrain_super_final_ckpt_radiov4_1370_0311/checkpoints"
