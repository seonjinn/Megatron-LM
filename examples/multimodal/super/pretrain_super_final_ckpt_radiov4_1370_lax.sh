...
#SBATCH --job-name=pretrain_super_final_ckpt_radiov4_1370_0311
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="pretrain_super_final_ckpt_radiov4_1370_0311"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/scratch/fsw/portfolios/llmservice/projects/llmservice_nemotron_super/users/tpoon/checkpoints/super-final-ckpt-after-mtp-radio-v4-tp2-ep64"
...
if [[ $SLURM_SUBMIT_HOST == *"lbd-lax"* ]]; then
    ...
    DATA_TRAIN="/scratch/fsw/portfolios/llmservice/projects/llmservice_nemotron_super/eagle-next/omni_stage/yamls/pretrain_1370.yaml"
fi
