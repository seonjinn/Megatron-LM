...
#SBATCH -p batch,batch_large,batch_long
#SBATCH -t 04:00:00
#SBATCH --mem=0
...
#SBATCH --job-name=sft_super_omni_49k_svg_0407
...
DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/megatron-lm/yamls/sft.long_context.49k.ehsan.v13p77.2x.0330.yaml"
