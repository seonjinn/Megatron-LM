...
#SBATCH --job-name=sft_super_posttrained_radiov4_0114
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_super_posttrained_radiov4_0114"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/scratch/fsw/portfolios/llmservice/users/tpoon/workspace/output/pretrain_super_posttrained_radiov4_0114/checkpoints"
