...
#SBATCH --job-name=sft_super_omni_16k_svg_0407
...
DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/megatron-lm/yamls/sft_recipe_13p77.yaml"
