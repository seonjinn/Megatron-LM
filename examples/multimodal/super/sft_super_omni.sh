...
#SBATCH --job-name=sft_omni_super_0302
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/tpoon/workspace/output/pretrain_super_a2_0302/checkpoints"
...
DATA_TRAIN="/lustre/fs1/portfolios/llmservice/projects/llmservice_nlp_fm/datasets/eagle-next/omni_stage/yamls/omni.yaml"
