...
#SBATCH --job-name=pretrain_super_a2_svg_newcontainer_0422
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_pretrain_super_a2_svg_newcontainer_${DATETIME}"
    SPECIAL_TOKENS=" --special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box> <so_embedding> <so_start> <so_end> "
    DEBUG=1
else
    MODEL_NAME="pretrain_super_a2_svg_newcontainer_0422"
    SPECIAL_TOKENS=" --special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\> \<so_embedding\> \<so_start\> \<so_end\> "
fi
...
# Starting checkpoint: A1 SVG output
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/tpoon/workspace/output/pretrain_super_a1_svg_newcontainer_0422/checkpoints"
...
DATA_TRAIN="${SOURCE}/examples/multimodal/super/data_config/a2_yamls/audio_stage2.yaml"
