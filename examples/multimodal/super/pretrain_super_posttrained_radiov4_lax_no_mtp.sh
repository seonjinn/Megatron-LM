...
#SBATCH --job-name=pretrain_super_posttrained_radiov4_no_mtp_0127
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="pretrain_super_posttrained_radiov4_no_mtp_0127"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/scratch/fsw/portfolios/llmservice/users/tpoon/checkpoints/super-posttrained-radio-v4-tp2-ep64"
