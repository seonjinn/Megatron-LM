...
#SBATCH --job-name=sft_super_final_ckpt_conv3d_radiov4_1377_newcontainer_0422
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME=${MODEL_NAME:-"interactive_sft_super_final_ckpt_conv3d_radiov4_1377_newcontainer_${DATETIME}"}
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME=${MODEL_NAME:-"sft_super_final_ckpt_conv3d_radiov4_1377_newcontainer_0422"}
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
