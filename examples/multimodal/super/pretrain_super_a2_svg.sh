...
#SBATCH --job-name=pretrain_super_a2_svg_0407
...
DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/megatron-lm/a2_yamls/audio_stage2.yaml"
