...
# Starting checkpoint: 49k omni SVG output
CHECKPOINT_DIR=${CHECKPOINT_DIR:-"/lustre/fsw/portfolios/llmservice/users/${USER}/workspace/output/sft_super_omni_49k_svg_newcontainer_0422/checkpoints"}
