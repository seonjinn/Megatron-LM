...
#SBATCH --job-name=pretrain_nemotron_5_hybrid_8b_reasoning_cradio_vlm_v1_rc3_0703
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_pretrain_nemotron_5_hybrid_reasoning_8b_cradio_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="pretrain_nemotron_5_hybrid_reasoning_8b_cradio_vlm_v1_rc3_0703"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/nemotron_5_hybrid_reasoning_8b_cradio_vlm_v1_rc3_tp4_patched/"
