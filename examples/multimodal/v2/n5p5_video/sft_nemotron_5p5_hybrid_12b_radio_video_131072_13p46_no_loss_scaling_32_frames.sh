...
#SBATCH --job-name=sft_nm_5p5_h_12b_6k_cradio_vlm_v1_rc3_video_13p46_trimmed_31072_no_loss_scaling_32_frames_0826
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_nm_5p5_h_12b_6k_cradio_vlm_v1_rc3_video_13p46_trimmed_31072_no_loss_scaling_32_frames_0826"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
