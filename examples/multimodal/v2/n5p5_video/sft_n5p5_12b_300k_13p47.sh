...
#SBATCH --job-name=sft_n5p5_12b_300k_13p47_0908
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_n5p5_12b_300k_13p47_0908"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/megatron-lm5/DST_PATH3/ruler.yaml"
...
if [[ $DEBUG -eq 1 ]]; then
    ...
    TP=8
    CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/sft_nm_5p5_h_12b_6k_cradio_vlm_v1_rc3_video_13p48_131072_0818/checkpoints"
