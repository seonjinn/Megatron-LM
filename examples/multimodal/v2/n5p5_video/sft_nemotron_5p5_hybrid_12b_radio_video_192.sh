...
#SBATCH --job-name=sft_nm_5p5_h_12b_6k_cradio_vlm_v1_rc3_video_13p36_192_0726
...
DECODER_SEQ_LEN=65536 # 16384 # 32768 # 65536
VIDEO_MAX_NUM_FRAMES=192     # Values > 0 enable video max num frames.
USE_CP=1
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_nm_5p5_h_12b_6k_cradio_vlm_v1_rc3_video_13p36_192_0726"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
