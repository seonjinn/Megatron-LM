...
#SBATCH --job-name=sft_n5p5_12b_131072_13p46_more_code_no_wd_128_frames_0829
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_n5p5_12b_131072_13p46_more_code_no_wd_128_frames_0829"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/matthieul/eagle_recipe_online_packing/final_recipe/merged_13p46_lc_video_v1_v2_1.0_videoMult_1.0_more_code_0829.yaml"
