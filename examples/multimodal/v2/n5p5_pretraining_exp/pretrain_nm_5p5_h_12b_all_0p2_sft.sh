...
#SBATCH --job-name=pretrain_nm_5p5_h_12b_all_0p2_sft_1023
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_pretrain_nm_5p5_h_12b_all_0p2_sft_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="pretrain_nm_5p5_h_12b_all_0p2_sft_1023"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
