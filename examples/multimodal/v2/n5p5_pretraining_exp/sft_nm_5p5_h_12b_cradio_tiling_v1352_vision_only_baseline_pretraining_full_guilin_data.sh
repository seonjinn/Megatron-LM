...
#SBATCH --job-name=sft_nm_5p5_h_12b_cradio_1017_tiling_v1352_no_txt_pt_guilin_data
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_sft_nm_5p5_h_12b_cradio_tiling_v1352_no_txt_pt_guilin_data_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="sft_nm_5p5_h_12b_cradio_1017_tiling_v1352_no_txt_pt_guilin_data"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/lustre/fs1/portfolios/llmservice/projects/llmservice_fm_vision/users/matthieul/workspace/output/pretrain_nm_5p5_h_12b_guilin_reannotated_data_1017/checkpoints"
