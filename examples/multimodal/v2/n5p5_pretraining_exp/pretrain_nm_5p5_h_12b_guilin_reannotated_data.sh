...
#SBATCH --job-name=pretrain_nm_5p5_h_12b_guilin_reannotated_data_1017
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_pretrain_nm_5p5_h_12b_guilin_reannotated_data_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="pretrain_nm_5p5_h_12b_guilin_reannotated_data_1017"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/matthieul/repos_rebase/megatron-lm-vlm-hybrid-packing-1001/examples/multimodal/v2/n5p5_pretraining_exp/pretrain_dataset_commercial_guilin_reannotated_data.yaml"
