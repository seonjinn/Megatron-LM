...
#SBATCH --job-name=sft_nm_5p5_h_12b_cradio_1029_tiling_v1352_no_txt_pt_all_0p2_sft
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_sft_nm_5p5_h_12b_cradio_tiling_v1352_no_txt_pt_all_0p2_sft_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="sft_nm_5p5_h_12b_cradio_1029_tiling_v1352_no_txt_pt_all_0p2_sft"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/pretrain_nm_5p5_h_12b_all_0p2_sft_1023/checkpoints"
