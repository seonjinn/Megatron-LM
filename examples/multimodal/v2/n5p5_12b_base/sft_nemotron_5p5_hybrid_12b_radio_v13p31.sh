...
#SBATCH --job-name=sft_nemotron_5p5_hybrid_12b_cradio_vlm_v1_rc3_tiling_v13p31_0717
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_nemotron_5p5_hybrid_12b_cradio_vlm_v1_rc3_tiling_v13p31_0717"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/pretrain_nemotron_5p5_hybrid_12b_cradio_vlm_v1_rc3_tiling_0714/checkpoints"

DATA_TRAIN=/lustre/fsw/portfolios/llmservice/users/matthieul/eagle_recipe_online_packing/v13p31/eagle_sft_v13p31_nmh5r.yaml
