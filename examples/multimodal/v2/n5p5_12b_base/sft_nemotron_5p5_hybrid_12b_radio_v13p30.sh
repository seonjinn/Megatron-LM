...
#SBATCH --job-name=sft_nemotron_5p5_hybrid_12b_cradio_vlm_v1_rc3_tiling_v13p30_0717
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_nemotron_5p5_hybrid_12b_cradio_vlm_v1_rc3_tiling_v13p30_0717"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
