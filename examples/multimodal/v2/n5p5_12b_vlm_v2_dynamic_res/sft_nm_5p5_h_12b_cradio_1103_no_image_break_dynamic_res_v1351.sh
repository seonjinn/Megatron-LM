...
#SBATCH --job-name=sft_nm_5p5_h_12b_cradio_1103_no_image_break_dynamic_res_v1351
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_nm_5p5_h_12b_cradio_1103_no_image_break_dynamic_res_v1351"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/tpoon/workspace/output/pretrain_nm_5p5_h_12b0804_no_image_break_dynamic_res_v1340_0804/checkpoints"
...
if [[ $USE_DYNAMIC_RES -eq 1 ]]; then
    ...
    #     SPECIAL_TOKENS+=" \<image_break\>"
    # fi
    EXTRA_ARGS+=" --dynamic-resolution --dynamic-resolution-min-patches 1024 --conv-merging "
fi
