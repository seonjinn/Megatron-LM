...
#SBATCH --job-name=pretrain_nm_5p5_h_12b0804_no_image_break_dynamic_res_pixel_shuffle_bs_512_mix_dataset_v1340_0804
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="pretrain_nm_5p5_h_12b0804_no_image_break_dynamic_res_pixel_shuffle_bs_512_mix_dataset_v1340_0804"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
DATA_TRAIN="/lustre/fs1/portfolios/llmservice/users/ksapra/src/trainingvlm/megatron-vlm2-training/examples/multimodal/v2/data_config/pretrain_dataset_commercial_missing_750_and_250.yaml"
