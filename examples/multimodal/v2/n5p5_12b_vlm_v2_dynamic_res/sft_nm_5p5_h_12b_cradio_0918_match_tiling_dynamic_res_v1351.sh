...
#SBATCH --job-name=sft_nm_5p5_h_12b_cradio_1001_match_tiling_dynamic_res_v1351
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_nm_5p5_h_12b_cradio_1001_match_tiling_dynamic_res_v1351"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/tpoon/workspace/output/pretrain_nm_5p5_h_12b0804_match_tiling_dynamic_res_v1340_0804/checkpoints"
...
if [[ $USE_MATCH_TILING -eq 1 ]]; then
    ...
    EXTRA_ARGS+=" ${IMAGE_BREAK_TOKEN} --dynamic-resolution --match-tiling-dynamic-resolution --conv-merging"
