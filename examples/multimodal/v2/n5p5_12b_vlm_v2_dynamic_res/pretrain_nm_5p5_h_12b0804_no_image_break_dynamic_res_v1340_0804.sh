...
#SBATCH --job-name=pretrain_nm_5p5_h_12b0804_no_image_break_dynamic_res_v1340_0804
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="pretrain_nm_5p5_h_12b0804_no_image_break_dynamic_res_v1340_0804"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
