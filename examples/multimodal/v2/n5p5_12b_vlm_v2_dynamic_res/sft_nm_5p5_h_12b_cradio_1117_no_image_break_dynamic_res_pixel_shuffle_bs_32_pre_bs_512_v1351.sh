...
#SBATCH --job-name=sft_nm_5p5_h_12b_cradio_1117_no_image_break_dynamic_res_pixel_shuffle_bs_32_pre_bs_512_v1351
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_nm_5p5_h_12b_cradio_1117_no_image_break_dynamic_res_pixel_shuffle_bs_32_pre_bs_512_v1351"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/lustre/fs1/portfolios/llmservice/projects/llmservice_fm_vision/users/tpoon/workspace/output/pretrain_nm_5p5_h_12b0804_no_image_break_dynamic_res_pixel_shuffle_bs_512_v1340_0804/checkpoints"
