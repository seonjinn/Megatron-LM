...
#SBATCH --job-name=0_sft_llama3p1_8b_radio_bf16_offline_packing_tiling_seed_1_0703
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="0_sft_llama3p1_8b_radio_bf16_offline_packing_tiling_seed_1_0703"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
