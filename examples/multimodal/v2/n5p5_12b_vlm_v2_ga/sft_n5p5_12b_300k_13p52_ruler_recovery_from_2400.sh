...
#SBATCH --job-name=sft_n5p5_12b_300k_13p52_cot_ruler_only_from_iter_2400_1011
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_sft_n5p5_12b_300k_13p52_cot_ruler_only_from_iter_2400_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="sft_n5p5_12b_300k_13p52_cot_ruler_only_from_iter_2400_1011"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
#DATA_TRAIN="/lustre/fsw/portfolios/llmservice/users/trintamaki/workspace/megatron-lm3/lcb_ruler.yaml"
...
if [[ $DEBUG -eq 1 ]]; then
    ...
    TP=8
    CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/sft_n5p5_12b_49152_13p52_txt_video_lcb_recovery_1011_iter_2400/checkpoints"
