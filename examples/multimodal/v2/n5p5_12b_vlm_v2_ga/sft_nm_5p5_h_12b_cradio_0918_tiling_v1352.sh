...
#SBATCH --job-name=sft_nm_5p5_h_12b_cradio_1008_tiling_v1352
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_nm_5p5_h_12b_cradio_1008_tiling_v1352"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
CHECKPOINT_DIR="/lustre/fs1/portfolios/llmservice/projects/llmservice_fm_vision/users/trintamaki/workspace/output/pretrain_nm_5p5_h_12b_1007/checkpoints"
