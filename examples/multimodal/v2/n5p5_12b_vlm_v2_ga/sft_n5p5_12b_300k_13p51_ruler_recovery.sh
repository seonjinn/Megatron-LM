...
#SBATCH --job-name=sft_n5p5_12b_300k_13p47_0923_cot_ruler_only
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="sft_n5p5_12b_300k_13p47_0923_cot_ruler_only"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
if [[ $DEBUG -eq 1 ]]; then
    ...
    TP=8
    CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/sft_n5p5_12b_49152_13p51_txt_video_cot_lcb_recovery_0922/checkpoints/"
