...
#SBATCH --job-name=sft_n5p5_12b_49152_13p52_txt_video_1009
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_sft_n5p5_12b_49152_13p52_txt_video_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="sft_n5p5_12b_49152_13p52_txt_video_1009"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
if [[ $DEBUG -eq 1 ]]; then
    ...
    TP=8
    CHECKPOINT_DIR="/lustre/fsw/portfolios/llmservice/users/matthieul/workspace/output/sft_nm_5p5_h_12b_cradio_1008_tiling_v1352/checkpoints"
