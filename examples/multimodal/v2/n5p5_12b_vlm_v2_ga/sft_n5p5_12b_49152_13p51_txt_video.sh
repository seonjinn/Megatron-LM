...
#SBATCH --job-name=sft_n5p5_12b_49152_13p51_txt_video_0921
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_sft_n5p5_12b_49152_13p51_txt_video_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="sft_n5p5_12b_49152_13p51_txt_video_0921"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
...
if [[ $DEBUG -eq 1 ]]; then
    ...
    TP=8
    CHECKPOINT_DIR="/lustre/fs1/portfolios/llmservice/projects/llmservice_fm_vision/users/amalasanjayd/workspace/output/sft_nm_5p5_h_12b_cradio_0918_tiling_v1351/checkpoints"
