...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_sft_llama_nemotron_49b_super_radio_${DATETIME}"
...
EXTRA_ARGS+=" --recompute-granularity full --recompute-method block --recompute-num-layers 80 --recompute-vision "
...
OPTIONS=" \
    ...
    --language-model-type llama_nemotron_super_49b \
    ${EXTRA_ARGS} \
