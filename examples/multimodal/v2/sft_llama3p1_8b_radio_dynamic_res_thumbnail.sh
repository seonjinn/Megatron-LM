...
#SBATCH --job-name=sft_llama_3p1_8b_radio_vlm_rc3_v13p16_dynamic_res_thumbnail_0807
...
if [[ $BATCH -eq 0 ]]; then
    ...
    MODEL_NAME="interactive_sft_llama_3p1_8b_radio_dynamic_res_thumbnail_${DATETIME}"
    SPECIAL_TOKENS="--special-tokens <image> <img> </img> <quad> </quad> <ref> </ref> <box> </box>"
    DEBUG=1
else
    MODEL_NAME="sft_llama_3p1_8b_radio_vlm_rc3_v13p16_dynamic_res_thumbnail_0807"
    SPECIAL_TOKENS="--special-tokens \<image\> \<img\> \</img\> \<quad\> \</quad\> \<ref\> \</ref\> \<box\> \</box\>"
fi
