...
class _ParamAndGradBucketGroup:
    ...
    def __init__(
        ...
        # responsible for, params_with_grad_counts is a dict mapping parameters to
        # number of times `register_grad_ready` is called for that parameter.
        # When overlap_grad_reduce is True, communication (all-reduce or reduce-scatter)
        # is issued when params_with_grad_counts equals golden_params_with_grad_counts.
        ...
        # Keeps track of number of times we run through param in a forward pass. Should be 1 for
        # most params but could be greater than 1 if control flow passes through the same parameter
        # multiple times. We lazily populate this in the first batch.
