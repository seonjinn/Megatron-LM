...
class MegatronMultimodalTokenizer:
    ...
    def _lookup_special_token_id(self, token: str) -> Optional[int]:
    ...
    def _plain_text(content: Union[str, List[Dict[str, Any]]]) -> str:
        ...
        return "".join(part["text"] for part in MegatronMultimodalTokenizer._as_parts(content) if part["type"] == "text")
    ...
    def _render_conversation(
        ...
        """Lower a list of structured turns to (chat-template-ready turns, per-turn replacements)."""
    ...
    def tokenize_conversation(
        ...
        **kwargs
        ...
        ``[{"type": "text", "text": str}, {"type": "image"}, {"type": "audio", "num_embeddings": int}]``.
    ...
    def detokenize(self, tokens: List[int]):
        ...
        sentinels = {self._image_token_index: self._image_part_text(),
    ...
    def add_special_tokens(self, special_tokens: List[str]):
        """Add special tokens."""
        self._tokenizer.add_tokens(special_tokens, special_tokens=True)
