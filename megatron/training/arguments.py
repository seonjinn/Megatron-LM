...
def _add_regularization_args(parser):
    ...
    group.add_argument('--use-independent-wd', action='store_true',
                       help='If set, use independent weight decay for adamW optimizer.')
...
def _add_training_args(parser):
    ...
    group.add_argument('--use-fused-weighted-squared-relu', action='store_true',
                       ...
                       dest='use_fused_weighted_squared_relu')
...
def _add_checkpointing_args(parser):
    ...
    group.add_argument('--defragment-memory-before-ckpt-save', action='store_true', default=False,
                       help='Defragment memory before saving checkpoint. Default is False.')
    return parser
...
def _add_moe_args(parser):
    ...
    group.add_argument('--moe-pad-experts-for-cuda-graph-inference', action='store_true',
                       help='Pads the input for each expert during decode for cudagraphs')
    return parser
